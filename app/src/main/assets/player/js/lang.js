...
if( bIsAndroidTv ) {
	i18n.guideControls = {
		en: '<li><kbd>P <span class="arrow arrow-up"></span></kbd>/<kbd>P <span class="arrow arrow-down"></span></kbd> - next/previous channel</li><li><kbd><span class="arrow arrow-left"></span></kbd> - open channel list</li><li><kbd><span class="arrow arrow-left"></span></kbd>+<kbd><span class="arrow arrow-left"></span></kbd> - open group list and other options (settings, search, EPG overview)</li><li><kbd><span class="arrow arrow-right"></span></kbd> - open channel settings</li><li><kbd>&#x23CE;</kbd> - show channel info</li><li><kbd>&#x23CE;</kbd>+<kbd>&#x23CE;</kbd> - show playback controls</li>'
	};
} else {
	i18n.guideControls = {
		en: '<li><kbd class="guide-icon swipe-up"></kbd> / <kbd class="guide-icon swipe-down"></kbd> - next/previous channel</li><li><kbd class="guide-icon swipe-right"></kbd> - open channel list</li><li><kbd class="guide-icon swipe-right"></kbd><kbd class="guide-icon swipe-right"></kbd> - open group list and other options (settings, EPG overview)</li><li><kbd class="guide-icon swipe-left"></kbd> - open channel settings</li><li><kbd class="guide-icon single-tap"></kbd> - show channel info</li><li><kbd class="guide-icon double-tap"></kbd> - show playback controls</li>'
	};
	i18n.channelSettingCameraCutout = {
